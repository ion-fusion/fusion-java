...
import static dev.ion_fusion.fusion.BindingDoc.COLLECT_DOCS_MARK;
import static dev.ion_fusion.fusion.FusionIo.safeWrite;
import static dev.ion_fusion.fusion.FusionList.immutableList;
import static dev.ion_fusion.fusion.FusionList.unsafeListElement;
import static dev.ion_fusion.fusion.FusionSexp.unsafePairHead;
import static dev.ion_fusion.fusion.FusionSexp.unsafePairTail;
import static dev.ion_fusion.fusion.FusionString.stringToJavaString;
import static dev.ion_fusion.fusion.FusionStruct.emptyStruct;
import static dev.ion_fusion.fusion.FusionStruct.immutableStruct;
import static dev.ion_fusion.fusion.FusionStruct.nullStruct;
import static dev.ion_fusion.fusion.FusionSymbol.BaseSymbol.internSymbol;
import static dev.ion_fusion.fusion.FusionValue.isAnnotated;
import static dev.ion_fusion.fusion.FusionValue.isAnyNull;
import static dev.ion_fusion.fusion.FusionVoid.isVoid;
import static dev.ion_fusion.fusion.FusionVoid.voidValue;
import static dev.ion_fusion.fusion.LetValuesForm.compilePlainLet;
import dev.ion_fusion.fusion.BindingDoc.Kind;
import dev.ion_fusion.fusion.FusionStruct.StructFieldVisitor;
import dev.ion_fusion.fusion.FusionSymbol.BaseSymbol;
import dev.ion_fusion.fusion.LambdaForm.CompiledLambdaBase;
import dev.ion_fusion.fusion.LambdaForm.CompiledLambdaExact;
import dev.ion_fusion.fusion.LocalEnvironment.CompiledImmediateVariableReference;
import dev.ion_fusion.fusion.LocalEnvironment.CompiledImmediateVariableSet;
import dev.ion_fusion.fusion.LocalEnvironment.CompiledLocalVariableReference;
import dev.ion_fusion.fusion.LocalEnvironment.CompiledLocalVariableSet;
import dev.ion_fusion.fusion.LocalEnvironment.LocalBinding;
import dev.ion_fusion.fusion.ModuleNamespace.CompiledImportedVariableReference;
import dev.ion_fusion.fusion.ModuleNamespace.CompiledModuleVariableReference;
import dev.ion_fusion.fusion.ModuleNamespace.ModuleDefinedBinding;
import dev.ion_fusion.fusion.ModuleNamespace.ProvidedBinding;
import dev.ion_fusion.fusion.Namespace.CompiledNsDefine;
import dev.ion_fusion.fusion.Namespace.CompiledNsDefineSyntax;
import dev.ion_fusion.fusion.Namespace.CompiledNsDefineValues;
import dev.ion_fusion.fusion.Namespace.NsDefinedBinding;
import dev.ion_fusion.fusion.Namespace.RequiredBinding;
import dev.ion_fusion.fusion.TopLevelNamespace.CompiledFreeVariableReference;
import dev.ion_fusion.fusion.TopLevelNamespace.CompiledTopDefine;
import dev.ion_fusion.fusion.TopLevelNamespace.CompiledTopDefineValues;
import dev.ion_fusion.fusion.TopLevelNamespace.CompiledTopLevelVariableReference;
import dev.ion_fusion.fusion.TopLevelNamespace.TopLevelDefinedBinding;
