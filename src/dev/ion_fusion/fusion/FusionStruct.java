...
import static dev.ion_fusion.fusion.FusionBool.falseBool;
import static dev.ion_fusion.fusion.FusionBool.makeBool;
import static dev.ion_fusion.fusion.FusionCompare.EqualityTier.LOOSE_EQUAL;
import static dev.ion_fusion.fusion.FusionCompare.EqualityTier.STRICT_EQUAL;
import static dev.ion_fusion.fusion.FusionCompare.EqualityTier.TIGHT_EQUAL;
import static dev.ion_fusion.fusion.FusionIo.dispatchIonize;
import static dev.ion_fusion.fusion.FusionIo.dispatchWrite;
import static dev.ion_fusion.fusion.FusionIterator.iterate;
import static dev.ion_fusion.fusion.FusionList.checkNullableListArg;
import static dev.ion_fusion.fusion.FusionList.unsafeJavaIterate;
import static dev.ion_fusion.fusion.FusionList.unsafeListSize;
import static dev.ion_fusion.fusion.FusionSymbol.BaseSymbol.internSymbols;
import static dev.ion_fusion.fusion.FusionSymbol.makeSymbol;
import static dev.ion_fusion.fusion.FusionText.checkRequiredTextArg;
import static dev.ion_fusion.fusion.FusionText.textToJavaString;
import static dev.ion_fusion.fusion.FusionText.unsafeTextToJavaString;
...
import dev.ion_fusion.fusion.FusionBool.BaseBool;
import dev.ion_fusion.fusion.FusionCollection.BaseCollection;
import dev.ion_fusion.fusion.FusionCompare.EqualityTier;
import dev.ion_fusion.fusion.FusionIterator.AbstractIterator;
import dev.ion_fusion.fusion.FusionSymbol.BaseSymbol;
import dev.ion_fusion.fusion.util.function.BiFunction;
import dev.ion_fusion.fusion.util.function.BiPredicate;
import dev.ion_fusion.fusion.util.hamt.MultiHashTrie;
