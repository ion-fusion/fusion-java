...
import static dev.ion_fusion.fusion._Private_CoverageCollectorImpl.fromDirectory;
...
public class FusionRuntimeBuilder
{
    ...
    public static final String PROPERTY_BOOTSTRAP_REPOSITORY =
        "dev.ion_fusion.fusion.BootstrapRepository";
    ...
    public static final String PROPERTY_COVERAGE_DATA_DIR =
        "dev.ion_fusion.fusion.coverage.DataDir";
